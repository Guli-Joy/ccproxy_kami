...
try {
	if (!($islogin == 1)) {
		logSecurityEvent('UNAUTHORIZED_ACCESS', '未授权访问管理页面');
	...
	exit('<script language=\'javascript\'>alert("' . $e->getMessage() . '");window.location.href=\'login.php\';</script>');
}
?>
<!DOCTYPE html>
<html>
